...
- [x] В углу canvas добавлен локальный mute/unmute активного видео предпросмотра; состояние не сохраняется в template snapshot и не влияет на worker-рендер.
- [x] Рядом с mute/unmute добавлена локальная регулировка громкости предпросмотра от 0% до 100%.
- [x] На поиске Twitch-клипов добавлен iframe-предпросмотр первого результата с модальной swipe-навигацией, экранными стрелками, клавиатурой и добавлением текущего клипа в избранное.
