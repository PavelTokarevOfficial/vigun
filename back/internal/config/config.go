...
type Config struct {
	HTTPAddr, DatabaseURL, S3Endpoint, S3PublicEndpoint, S3AccessKey, S3SecretKey, S3Bucket, S3Region, TwitchClientID, TwitchClientSecret, InstagramAppSecret, InstagramAPIVersion, FFMPEG, Whisper, WhisperModel, BrowserBin string
	FFmpegPreset                                                                                                                                                                                                              string
